// Anleitungs-PDF-Generator Kompakt-Variante
// Stand 06.05.2026, Erstbau eigenständiges Kompakt-Script.
//
// Eigenständiges Schwester-Script zu build-anleitung-pdf.mjs (Lang-Variante).
// Editorial-CSS unverändert übernommen, nur MD_SRC und PDF_OUT angepasst.
//
// Erzeugt /public/anleitungen/hausverwalter-wechseln-kompakt.pdf
// aus der Kompakt-Markdown-Quelle. Pipeline:
...
const MD_SRC = '/Users/andredieckmann/Desktop/Proimma GmbH/00_Projekt_Setup_2026/Anleitungen/Anleitung_Hausverwalter-wechseln-Kompakt_2026-05-05.md';
const PDF_OUT = resolve(REPO_ROOT, 'public/anleitungen/hausverwalter-wechseln-kompakt.pdf');
...
<head>
<meta charset="UTF-8">
<title>Hausverwalter wechseln in fünf Schritten — Kompakt</title>
<style>
@font-face {
...
// Temp-HTML schreiben
const tmpDir = await mkdtemp(join(tmpdir(), 'anleitung-pdf-kompakt-'));
const tmpHtml = join(tmpDir, 'anleitung-kompakt.html');
